...
.. _accessing-accessions-page:

Accessing the Accessions Page
------------------------------

Create a profile [#f1]_ following the steps in :ref:`profile-types`. Then,
access the **Accessions** [#f2]_ page via any of the following methods:

Using the Components Button
~~~~~~~~~~~~~~~~~~~~~~~~~~~

Click the |accessions-component-button| component button in the **Components**
[#f3]_ column as shown below:
...
.. grid::
   ...
   .. grid-item::
      ...
      .. figure::  /assets/images/accessions/buttons/accessions-button-pointer-tol.png
         ...
         **Button to access the Accessions page under Tree of Life profiles
         (highlighted)**
   ...
   .. grid-item::
      ...
      .. figure::  /assets/images/accessions/buttons/accessions-button-pointer-biodata.png
         ...
         **Button to access the Accessions page under Biodata profiles
         (highlighted)**
...
.. grid::
   ...
   .. grid-item::
      ...
      .. figure:: /assets/images/accessions/icons/accessions-icon-pointer-tol.png
         ...
         **Navigation pane showing the Accessions component icon (Tree of Life
         profiles)**
   ...
   .. grid-item::
      ...
      .. figure:: /assets/images/accessions/icons/accessions-icon-pointer-biodata.png
         ...
         **Navigation pane showing the Accessions component icon (Biodata
         profiles)**
