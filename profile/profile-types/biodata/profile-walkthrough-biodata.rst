.. _profile-walkthrough-biodata:

Biodata Profile
---------------

Biodata profile [#f1]_ is a work profile that is used to submit research
objects [#f2]_ such as single-cell data, images and other data that are not
associated with a specific project. It was formerly known as *Genomics*
profile.

See the :ref:`components <biodata-profile-components>` section below for the
types of data that can be submitted using this profile.

.. raw:: html

   <hr>

Steps to Create a Biodata Profile
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

#. On the **Work profiles** page, choose the **Biodata** profile type from the
...
#. Provide details for the new profile then, click **Save**
    ...
    .. hint::
      ...
      Both profile **Title** and profile **Description** are mandatory form
      fields.
...
#. The new profile will be displayed on the **Work profiles** page.
    ...
    .. hint::
      ...
      created, title or type. See :ref:`Sorting Profiles <sorting-profiles>`
...
.. _biodata-profile-components:

Biodata Profile Components
~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
component (see the *Biodata profile components* image below).
...
.. grid::
   ...
   .. grid-item::
      ...
      * :ref:`Samples <samples-component-biodata>`
      * :ref:`Reads <reads>`
      * :ref:`Single-cell <single-cell-submissions>`
      * :ref:`Accessions <accessions>`
      * :ref:`Images <image-submission>`
