...
If using the :abbr:`COPO (Collaborative OPen Omics)` project documentation in
...
The Collaborative OPen Omics (COPO) project is maintained by a team based at
the
`Earlham Institute <https://www.earlham.ac.uk/>`__. The project is :abbr:`MIT
(Massachusetts Institute of Technology)`
licensed while the documentation is licensed under the
`Apache License 2.0 <https://www.apache.org/licenses/LICENSE-2.0>`__. Refer to
the :ref:`overview` section for more
details.
