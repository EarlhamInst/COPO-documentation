.. _reads-submission-biodata:

Biodata Profile Reads Submission
---------------------------------

.. _reads-submission-biodata-note:
...
.. important::
   ...
   * This section applies if you are submitting reads to a Biodata
     profile [#f1]_. For reads submissions under Tree of Life (ToL) [#f2]_
     profiles, see :ref:`reads-submission-tol` section.
...
associated with a Biodata profile [#f1]_.

.. _accessing-reads-page-via-components-button-biodata:
...
.. _submit-manifest-reads-biodata:
...
2. Click the |reads-blank-manifest-download-button-biodata| button to download
...
3. Fill in the downloaded manifest then, click the
   |add-reads-manifest-button-biodata| button to upload it from your local
   (computer) system.
...
.. note::
   ...
   * Follow the steps in :ref:`submit-manifest-reads-biodata` to upload data
...
.. _reads-submission-make-public-biodata:
...
.. _reads-submission-status-biodata:
...
.. _reads-submission-accessions-biodata:
