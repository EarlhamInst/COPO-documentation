...
.. note::
   ...
   * The max total image size should be no more than 2GB.

   * Sample images can only be submitted via a Tree of Life profile [#f1]_.
     Please see:
...
#. Upload samples.
   ...
   .. note::
      ...
      Do not click the |finish-button| button after uploading the sample
...
#. In the sample spreadsheet dialogue, click the **Sample Images** tab then,
   ...
   .. important::
      ...
      The |upload-images-button| button becomes available only after uploading
      a sample manifest and must be used in the same session, as image uploads
...
#. Navigate to the **Samples** page.
   ...
   See :ref:`Accessing the Samples page <accessing-samples-page-tol>` section
   for guidance.

#. Select the records that you would like to view images for.

   Then, click the |view-images-button1| button to view their images.
...
#. If images exist, a popup will display the submitted images for the selected
   records.
   ...
   .. figure:: /assets/images/samples/modals/samples-view-images-dialogue-with-images-displayed.png
      ...
      **Popup showing submitted images for selected records**
   ...
   .. figure:: /assets/images/samples/modals/samples-view-images-dialogue-with-no-images-exist-message.png
      ...
      **Popup showing no images exist for selected records**
...
Assigned sample managers should refer to :ref:`View submitted images
(Sample manager guide)
<image-submission-view-images-sample-managers>` for more information.
...
.. seealso::
   ...
   * :ref:`permits-submission-download-permits`
   * :ref:`Samples Submission (Tree of Life (ToL) profiles) <samples-submission-tol>`
