...
Statistics are generated for each COPO instance over time and by a variable.
The statistics are automatically updated and can be accessed on the
`Statistics page <statistics-page_>`__.
...
`Statistics <time-series-statistics-page_>`__ can be generated for the
following research object elements over time:
...
.. figure:: /assets/images/statistics/ui/statistics_over_time_with_dropdown_menu_web_page.png
   ...
   **COPO Statistics: Dropdown menu of research object elements that can be
   queried to get statistics of the number of samples over time**
...
`Statistics <variable-histogram-statistics-page_>`__ can be generated for the
number of samples submitted based on the research elements or variables such
as -
...
.. figure:: /assets/images/statistics/ui/statistics_by_variable_web_page.png
   ...
   **COPO Statistics: Bar graph illustrating total number of samples recorded
   for various** ``Lifestage`` **elements**
...
.. figure:: /assets/images/statistics/ui/statistics_by_variable_with_dropdown_menu_web_page.png
   ...
   **COPO Statistics: Dropdown menu of elements/variables that can be queried
   to get statistics of the number of samples**

..
    Link declaration
..

.. _statistics-page: https://copo-project.org/copo/tol_dashboard/stats/
.. _time-series-statistics-page: https://copo-project.org/copo/tol_dashboard/stats/
.. _variable-histogram-statistics-page: https://copo-project.org/copo/tol_dashboard/stats/variable_histogram
