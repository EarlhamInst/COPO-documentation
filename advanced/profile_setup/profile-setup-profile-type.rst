...
* ``description`` (String):
     ...
     **Examples**:
        ...
        * ``Biodata``: A profile that operates independently.
...
.. collapse:: ProfileType database fields and records
   ...
   .. code-block:: bash
       ...
       id |   type   |                     description                     |
       widget_colour | is_dtol_profile | is_permission_required
      ----+----------+-----------------------------------------------------+---
      -------------+-----------------+------------------------
        1 | biodata  | Biodata                                             |
        #009c95       | f               | f
        2 | dtol     | Darwin Tree of Life (DTOL)                          |
        #16ab39       | t               | t
        3 | dtolenv  | Darwin Tree of Life Environmental Samples (DTOLENV) |
        #fb7d0d       | t               | t
        4 | asg      | Aquatic Symbiosis Genomics (ASG)                    |
        #5829bb       | t               | t
        5 | erga     | European Reference Genome Atlas (ERGA)              |
        #E61A8D       | t               | t
        6 | test     | Test New Profile                                    |
        violet        | f               | t
...
.. figure:: /assets/images/django_admin_interface/profile/profile_type/visual_display_profile_types_without_dropdown_menu.png
   ...
   :align: center
   :target: https://raw.githubusercontent.com/EarlhamInst/COPO-documentation/main/assets/images/django_admin_interface/profile/profile_type/visual_display_profile_types_without_dropdown_menu.png
...
.. figure:: /assets/images/django_admin_interface/profile/profile_type/visual_display_profile_types_with_dropdown_menu.png
   ...
   :align: center
   :target: https://raw.githubusercontent.com/EarlhamInst/COPO-documentation/main/assets/images/django_admin_interface/profile/profile_type/visual_display_profile_types_with_dropdown_menu.png
   :class: with-shadow with-border
...
.. figure:: /assets/images/django_admin_interface/profile/profile_type/visual_display_profile_types_created_profiles.png
   ...
   :align: center
   :target: https://raw.githubusercontent.com/EarlhamInst/COPO-documentation/main/assets/images/django_admin_interface/profile/profile_type/visual_display_profile_types_created_profiles.png
   :class: with-shadow with-border
