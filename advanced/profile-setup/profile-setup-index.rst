...
.. collapse:: ProfileType model
   ...
   .. literalinclude:: /assets/files/setup/profile/profile-type-model.py
      :language: python
...
.. collapse:: Component model
   ...
   .. literalinclude:: /assets/files/setup/profile/component-model.py
      :language: python
...
.. collapse:: RecordActionButton model
   ...
   .. literalinclude:: /assets/files/setup/profile/record-action-button-model.py
      :language: python
...
.. collapse:: TitleButton model
   ...
   .. literalinclude:: /assets/files/setup/profile/title-button-model.py
      :language: python
...
After registering the models, create a ``setup-profile-types.py`` Django
...
.. hint::
   ...
   Python management command file, ``setup-profile-types.py``. The actual
...
.. collapse:: Setup profile management command
   ...
   .. literalinclude:: /assets/files/setup/profile/setup-profile-types.py
      :language: python
      :caption: Python **setup-profile-types.py** Python management command
                file contents
